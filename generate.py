...
- Name only documents that contain a fact you actually stated. Several excerpts may be about the same building or the same course; if an excerpt does not contain something you said, do not name it, however related it looks.
